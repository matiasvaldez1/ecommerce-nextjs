...
export default function Component() {
  return (
    ...
    <div className="w-6/12 h-[400px] m-auto grid place-content-center">
      ...
      <button  className="bg-cyan-600 text-white p-2 rounded-md hover:opacity-70 my-2"  onClick={() => signIn("google",{ callbackUrl: `https://loudrop-store.vercel.app` })}>Sign in with Google</button>
    </div>
    </>
  )
}